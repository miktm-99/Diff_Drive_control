...
class DiffDriveController:
    def __init__(self):
        ...
        self.a = rospy.get_param('~a', 2.0)  # Distanza punto B dal centro
    ...
    def control(self, e, v_d, w_d):
        ...
        if e[2] == 0: #e_3
            u_2 = -self.k2*v_d*e[1] - self.k3(v_d,w_d)*e[2]
        else:
    ...
    def compute_tracking_error(self, desired_pose):
        ...
        e = np.dot(self.R_t, pose_error)  # Coordinate errore nel frame del robot
    ...
    def control_loop(self, event):
        ...
        self.thetad_log.append(theta_d)
        self.v_d_log.append(v_d)
        self.w_d_log.append(w_d) 
        self.v_log.append(v)
    ...
    def plot_results(self):
        ...
        plt.plot(self.time_log, self.e2_log, 'm-', label='Errore theta') 
        plt.xlabel('Time [s]')
        plt.ylabel('Errore')
        plt.legend()
