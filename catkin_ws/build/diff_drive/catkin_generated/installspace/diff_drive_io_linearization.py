...
class DiffDriveController:
    def __init__(self):
        ...
        # Parametri del robot
        self.b = rospy.get_param('~b', 0.2)  # Distanza punto B dal centro
        self.wheel_radius = rospy.get_param('~wheel_radius', 0.05)
        self.wheel_separation = rospy.get_param('~wheel_separation', 0.3)
        
        # Parametri del controller
        self.k1 = rospy.get_param('~k1', 0.8)
    ...
    def ref_trajectory(self, t):
        ...
        doty1d = 2 * self.R * self.w_d * np.cos(2 * self.w_d * t)
        doty2d = self.R * self.w_d * np.cos(self.w_d * t)
    ...
    def plot_results(self):
        ...
        plt.plot(self.y1_log, self.y2_log, 'b-', label='Actual')
        plt.xlabel('y1')
        plt.ylabel('y2')
